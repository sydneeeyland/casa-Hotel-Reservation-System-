      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm add_room" data-toggle="modal" data-target="#add_room_modal"><i class="fas fa-plus fa-sm text-white-50"></i> Add New</a>
          </div>
          ...
          <div class="row">
            ...
            {
              if($row['room_availability'] == 1)
              {
            ?>
              <div class="col-3">
                <div class="card mb-4 py-3 border-left-success">
                  <div class="card-body" style="height: 280px; overflow: hidden;">
                    <h5 class="card-title"><?php echo $row['room_name']; ?>
                    </h5>
                    <hr>
                    <h6 class="card-title">Room Number: <?php echo $row['room_number']; ?></h6>
                    <h6 class="card-title">Room Price: <?php echo $row['room_price']; ?></h6>
                    <hr><u>Room Info</u>
                    <p class="card-text" align="justify"><?php echo $row['room_info']; ?></p>
                  </div>
                </div>
              </div>
            <?php
