            ...
            <form method="post" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
                <div class="col-md-6 form-group">
                  ...
                  <input type="text" class="form-control" name="reg_first_name" required>
                </div>
                <div class="col-md-6 form-group">
                  <label class="text-black font-weight-bold">Last Name</label>
                  <input type="text" class="form-control" name="reg_last_name" required>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6 form-group">
                  ...
                  <input type="password" class="form-control" name="reg_password2" required>
                </div>
              </div>

              <div class="row">
                <div class="col-md-6 form-group">
                  <label class="font-weight-bold text-black">Mobile #</label>
                  <input type="text" class="form-control" name="reg_mobile" required>
                </div>
                <div class="col-md-6 form-group">
                  <label class="font-weight-bold text-black">Telephone #</label>
                  <input type="text" class="form-control" name="reg_telephone" required>
                </div>
              </div>

              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="submit" value="Register" name="reg_info" class="btn btn-primary text-white py-3 px-5">
                </div>
              </div>
            </form>
